...
public class DungeonBedRoom extends DungeonBase {
  ...
  public DungeonBase generate(Coord origin, List<Direction> entrances) {
    ...
    worldEditor.getTreasureChestEditor().createChest(cursor.add(Direction.UP), false, Dungeon.getLevel(cursor.getY()), side.reverse(), getRoomSetting().getChestType().orElse(ChestType.STARTER));
