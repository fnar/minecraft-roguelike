...
public class CornerRoom extends DungeonBase {
  ...
  private void createCeiling(WorldEditor editor, Random rand, Coord origin, BlockSet primary) {
  ...
  private void createHollowCenter(WorldEditor editor, Random rand, Coord origin) {
  ...
  private void createShell(WorldEditor editor, Random rand, Coord origin, IBlockFactory blocks) {
  ...
  private void fillFloor(WorldEditor editor, Random rand, Coord origin, IBlockFactory floor) {
