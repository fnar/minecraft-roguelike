...
public class GreymerkLootRules extends DungeonSettings {

  public static final SettingIdentifier ID = new SettingIdentifier(SettingsContainer.GREYMERK_NAMESPACE, "loot");
